...
export class UciEngine {
    ...
    async init() {
        if (this.worker) {
            ...
            await this.sendCommands(['setoption name UCI_ShowWDL value true', 'isready', `setoption name UCI_LimitStrength value true`,
                `setoption name UCI_Elo value ${this.elo}`], 'readyok');
